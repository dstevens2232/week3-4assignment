...
public class VariablesAndOperations {
	...
	public static void main(String[] args) {
		...
		String customerFirstName = "Dave"; 
		
		//create a variable to hold a street address
		String streetAddress = "2200 nw 103rd street";
		
		//print all variables to the console 
		System.out.println("Available seats left on the plane: " +  availablePlaneSeats); 
		System.out.println(costOfGroceries + " Is The total amount for the groceries");
		...
		//the season has changed, update the hot outside variable to the opposite of what is was
		//isHotOutside = true;
		isHotOutside =! isHotOutside;
		System.out.println(isHotOutside);
		
		//create a new variable called full name using the customer's first name, the middle initial, and a last name of choice
		String fullName = customerFirstName + " " + middleInitial + " Hall"; 
